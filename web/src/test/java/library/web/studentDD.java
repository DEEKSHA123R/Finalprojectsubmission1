...
public class studentDD {
  ...
  public void f(String mail) throws InterruptedException {
	 
		driver.findElement(By.className("loginbtn")).click();
		driver.findElement(By.className("login-page"));
		driver.findElement(By.className("toggle-btn1"));
		driver.findElement(By.id("e-mail")).sendKeys(mail);
		driver.findElement(By.xpath("//*[@id=\"pass-id\"]")).sendKeys("Shetty1234#");
 ...
 @DataProvider
  ...
  File src=new File("C:\\studentDD\\Book2.xlsx");
